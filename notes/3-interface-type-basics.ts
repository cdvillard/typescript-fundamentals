...
const d2: PhoneNumberDict = {};
// If 'undefined' wasn't specificed as a return type,
// this conditional would allow a value to be assigned
// to a non-existent dictonary key.
if (d2.abc) {
  console.log(typeof d2.abc)
}

const phoneDict: PhoneNumberDict = {
  office: { areaCode: 321, num: 5551212 },
  home: { areaCode: 321, num: 5550010 },
  work: { areaCode: 129, num: 8289329}
   // try editing me
};
...
type NumberVal = 1 | 2 | 3 | NumberArr; // ERROR c ircular reference
type NumberArr = NumberVal[]; // ERROR circular reference
const x: NumberVal2 = [3, [2, 1, 2, 1, 1]];
...
const y: StringVal = Math.random() > 0.5 ? "b" : ["a"]; // ✅ ok!
